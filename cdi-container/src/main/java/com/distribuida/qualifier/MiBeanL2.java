...
public @interface MiBeanL2 { //@interfaz para crear anotación (qualifier)
	...
	public static final class Literal extends AnnotationLiteral<MiBeanL2> implements MiBeanL2 {
